...
// class selectorsModal {
//     constructor({ title, type, elements }: selectorsModal) {
//         this.title = title;
//         this.type = type;
...
// class Modal {
//     constructor({ title, type, elements }: Modal) {
//         this.title = title;
//         this.type = type;
//         this.elements = elements;
//     }
...
//                     break;
//                 case 'selectors':
//                     let obj: { values: Boolean[], error: HTMLSpanElement } = { values: [], error: errorElem };
...
//         btn2.onclick = () => {
//             if (this.type === 'newProject') newProject(values[0]);
//         }
